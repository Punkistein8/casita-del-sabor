<div class="my-5 flex flex-row justify-center gap-3 items-center">
  ...
  <h1 class="text-3xl">Editar <span class="text-emerald-600">Platillo</span></h1>
</div>
    ...
    <form class="flex flex-col w-1/3 p-7 m-10 rounded-xl shadow-xl shadow-gray-300 bg-gray-100" method="POST" action="<?php echo site_url('hombres/editarHombre'); ?>/<?php echo $prendaEditar->id_ph ?>">
      <ul class="flex flex-col gap-5">
        ...
        <li class="flex flex-row">
          ...
          <a href="<?= site_url('hombres/indexPriv') ?>" class="text-center w-full p-2 rounded-xl rounded-l-none cursor-pointer bg-red-500 hover:bg-red-600 text-white text-xl">Cancelar</a>
        </li>
      </ul>
    </form>
  </div>
