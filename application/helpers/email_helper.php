...
function enviarEmail(
  ...
  try {
    ...
    $configuracionCorreo = array(
      'protocol' => 'smtp',
      'smtp_host' => 'smtp.gmail.com',  //a traves de que se va enviaar el correo
      'smtp_port' => '587',
      '_smtp_auth' => TRUE,
      'smtp_crypto' => 'tls',
      'smtp_user' => 'juan.barba5400@utc.edu.ec',
      'smtp_pass' => 'barbin9808  ',
      'mailtype' => 'html',
      'send_multipart' => TRUE,
      'wordwrap' => TRUE,
      'charset' => 'utf-8',
    ...
    $CI->email->from("yessenia.quinatoa7482@utc.edu.ec");
