...
class Alcoholes extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->load->view('alcoholes/index-public', $data);
  ...
  public function indexUsuario()
  {
    $data["listaAlcoholes"] = $this->alcohol->getAlcoholes();
    $this->load->view('header');
    $this->load->view('alcoholes/index-users', $data);
    $this->load->view('footer');
  }
  public function listaCarrito()
  {
    $data["listaAlcoholes"] = $this->alcohol->getAlcoholes();
    $this->load->view('alcoholes/carrito', $data);
  }
  public function guardarAlcohol()
  {
    ...
    if ($this->alcohol->insertarAlcohol($datosNuevoAlcohol)) {
      redirect('alcoholes/indexPriv'); //redirecciona a la vista index
    } else {
      echo "<h1>No</h1>";
    }
  }
